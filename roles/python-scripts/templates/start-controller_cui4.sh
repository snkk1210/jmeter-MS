...
# スプレッドシートに結果を出力
/usr/local/bin/main4.py ${LOGDIR}/${OPTIME}_th/statistics.csv http://${SELF_IPADDR}/${DATE}/${OPTIME}_th ${THREAD_NUM} ${RAMPUP_NUM} ${LOOP_NUM} ${NODE_NUM} ${SUM_THREAD_NUM} ${START_TIME} ${END_TIME}
